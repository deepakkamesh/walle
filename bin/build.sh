...
if [ "$(uname)" == "Darwin" ]; then
	protoc -I $PROJECT_ROOT/googleapis/  $PROJECT_ROOT/googleapis/google/assistant/embedded/v1alpha1/embedded_assistant.proto --go_out=plugins=grpc:../assistant
elif [ "$(expr substr $(uname -s) 1 5)" == "Linux" ]; then
	protoc -I ../sonny -I /usr/include/google/protobuf/  ../sonny/sonny.proto --go_out=plugins=grpc:../sonny
fi

go build ../ && ./walle -creds=/Users/dkg/Downloads/walle_prototype.json
